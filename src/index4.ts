...
const grid2: (gridNode | null)[][] = new Array()

let cameraPos: vector2D = { x: 0, y: 0 }

//let ctx: CanvasRenderingContext2D | null;

function createEntity(position: vector2D, velocity: vector2D, radius: number) {
  const entity = { position, velocity, radius }
